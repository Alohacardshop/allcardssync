...
- [x] `src/components/RawCardIntake.tsx`: Migrated 1 console call to useLogger ✅
- [x] `src/components/RawComicIntake.tsx`: Migrated 2 console calls to useLogger ✅
- [x] `src/components/ShopifyRetryPanel.tsx`: Migrated 1 console call to useLogger ✅
- [x] `src/hooks/useBatchSendToShopify.ts`: Migrated 23 console calls to logger ✅
- [x] `src/hooks/useShopifySync.ts`: Migrated 7 console calls to logger ✅
- [x] `src/hooks/useShopifySyncConflicts.ts`: Migrated 3 console calls to logger ✅
- [x] `src/hooks/useShopifyUpsert.ts`: Migrated 1 console call to logger ✅
- [x] `src/hooks/useShopifyForceSync.ts`: Migrated 4 console calls to logger ✅
- [x] `src/hooks/useInventorySelling.ts`: Migrated 4 console calls to logger ✅

**All high-traffic components and business-critical hooks now use structured logging! 🎉**

Remaining: ~200 console calls in lower-priority UI components and utility functions.
