...
CREATE POLICY "Anyone can view label_templates"
ON public.label_templates
FOR SELECT
USING (true);

CREATE POLICY "Anyone can insert label_templates"
ON public.label_templates
FOR INSERT
WITH CHECK (true);

CREATE POLICY "Anyone can update label_templates"
ON public.label_templates
FOR UPDATE
USING (true);

CREATE POLICY "Anyone can delete label_templates"
ON public.label_templates
FOR DELETE
USING (true);
