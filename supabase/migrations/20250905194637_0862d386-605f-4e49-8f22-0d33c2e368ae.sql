...
-- and ensuring proper security context

-- Drop the existing views that reference old/non-existent tables
DROP VIEW IF EXISTS public.game_catalog_stats;

-- Recreate the game_catalog_stats view with correct table references
-- This view should reference the current catalog_v2.sets and catalog_v2.cards tables
