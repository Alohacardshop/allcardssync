-- Temporarily disable the snapshot trigger to avoid foreign key issues
ALTER TABLE intake_items DISABLE TRIGGER create_intake_item_snapshot_trigger;

-- Delete item_snapshots for graded and raw cards first (foreign key dependency)
...
-- Re-enable the snapshot trigger
ALTER TABLE intake_items ENABLE TRIGGER create_intake_item_snapshot_trigger;

-- Clean up empty lots that no longer have any items
