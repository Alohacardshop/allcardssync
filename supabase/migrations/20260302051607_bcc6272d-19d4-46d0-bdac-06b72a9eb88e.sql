...
-- Update create_raw_intake_item to clear sold_at on conflict (re-add)
...
-- Data fix: clear sold_at for the orphaned item so it appears in inventory
UPDATE intake_items 
SET sold_at = NULL, sold_price = NULL, sold_channel = NULL, sold_order_id = NULL
