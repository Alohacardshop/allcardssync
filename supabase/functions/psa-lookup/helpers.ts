...
export function normalizePsaCertData(oldCache: any): any {
  return {
    ...
    gradeLabel: oldCache.grade_label,
    year: oldCache.year,
    brandTitle: oldCache.brand,
    subject: oldCache.subject,
    cardNumber: oldCache.card_number,
    issueNumber: oldCache.issue_number,
    category: oldCache.category,
    varietyPedigree: oldCache.variety_pedigree,
    graderNotes: oldCache.grader_notes,
    publicationDate: oldCache.publication_date,
    language: oldCache.language,
    country: oldCache.country,
    pageQuality: oldCache.page_quality,
    gameSport: oldCache.game_sport,
...
export function transformPsaApiResponse(
  ...
  return {
    ...
    gradeLabel: psaCert?.CardGrade || undefined,
