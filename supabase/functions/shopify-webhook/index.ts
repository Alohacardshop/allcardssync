...
// getRegionDiscordConfig, getOrderRegionFromPayload, isOnlineOrderNeedingFulfillment,
// getOrderType, getOrderSource, and all embed helpers are now imported from _shared/discord-helpers.ts

// Legacy compatibility: getOrderRegion wrapper (used nowhere else now but kept for safety)
function getOrderRegion(payload: any): string {
  return getOrderRegionFromPayload(payload, null);
}
