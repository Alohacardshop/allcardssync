...
export function codeDefaultRawCard2x1(): LabelTemplate {
  return {
    ...
    layout: {
      ...
      height: 203,
      elements: [
        { type: 'text', id: 'cardname', x: 16, y: 12, font: '0', h: 28, w: 28, text: 'CARD NAME', maxWidth: 360 },
        { type: 'text', id: 'condition', x: 16, y: 48, font: '0', h: 24, w: 24, text: 'NM' },
        { type: 'text', id: 'price', x: 270, y: 15, font: '0', h: 30, w: 30, text: '$0.00' },
        { type: 'barcode', id: 'barcode', x: 16, y: 50, height: 52, moduleWidth: 2, hr: false, data: '5150233' },
        { type: 'text', id: 'desc', x: 16, y: 95, font: '0', h: 21, w: 21, text: 'Set • Name • #', maxWidth: 360 },
        { type: 'text', id: 'sku', x: 16, y: 120, font: '0', h: 15, w: 15, text: '5150233' },
      ],
    },
  };
}
