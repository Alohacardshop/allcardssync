...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      // Prevent the toaster viewport from blocking clicks on underlying UI while toasts animate in/out.
      // Individual toasts remain interactive via `pointer-events-auto` below.
