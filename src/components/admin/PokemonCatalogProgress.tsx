    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-3 gap-3 text-center">
          ...
          <div><div className="text-2xl font-semibold">{stats.pending}</div><div className="text-xs text-muted-foreground">Pending Sets</div></div>
        </div>
        <div className="flex gap-2">
          <Button onClick={load} variant="secondary" disabled={loading}>{loading ? "Refreshing…" : "Refresh"}</Button>
