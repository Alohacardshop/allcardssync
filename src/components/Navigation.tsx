...
import { Home, Package, Printer, Settings, FileText, Menu, LogOut, Upload, BarChart3, Archive, MapPin, Palmtree, Dice1, ArrowRightLeft } from "lucide-react";
...
export function Navigation({ showMobileMenu = true }: NavigationProps) {
  ...
  const navItems = [
    ...
    { to: "/bulk-transfer", label: "Bulk Transfer", icon: ArrowRightLeft },
